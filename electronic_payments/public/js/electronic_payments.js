...
electronic_payments.portal_payment_method_refresh = frm => {
			...
			primary_action: () => {
				selected.forEach(row => {
					frappe.call({
						...
						callback: function () {
							electronic_payments.remove_row_from_table(frm, row.name)
						},
					})
				})
				d.hide()
...
electronic_payments.remove_row_from_table = (frm, row_name) => {
