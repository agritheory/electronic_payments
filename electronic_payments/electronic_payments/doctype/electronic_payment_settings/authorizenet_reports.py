...
# 	merchantAuth = frappe.get_doc(
# 		"AuthorizeNet Settings", "Lancaster Lanterns"
# 	).merchant_auth()
...
# 									print(
# 										"  Charge Returned Items Amount: %.2f" % statistic.chargeReturnedItemsAmount
# 									)
...
# 									print(
# 										"  Refund Returned Items Amount: %.2f" % statistic.refundReturnedItemsAmount
# 									)
